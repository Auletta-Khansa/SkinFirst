      ...
      <>
        <section class="min-h-[50vh] px-30 pt-20 bg-gray-50">
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                <a href="#home" class="flex items-center mb-6 text-3xl font-bold text-primary-0 ">Login</a>
                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="#">
                            <div>
                                ...
                                <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="admin123" required="">
                                </input>
                            </div>
                            <div>
                            ...
                            <p class="text-sm font-medium text-primary-1 ">
                                Dont have an account yet? <Link to='/signup'><a href="#home" class="font-medium text-primary-4 underline">Sign up</a></Link>
                            </p>
                        </form>
                    </div>
                </div>
