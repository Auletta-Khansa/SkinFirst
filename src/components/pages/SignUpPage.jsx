                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form  onSubmit={addUser} class="space-y-4 md:space-y-6" action="#">
                            <div>
                                ...
                                <input type="username" name="username" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="admin123" required onChange={(e)=>setUsername(e.target.value)}/>
                            </div>
                            <div>
                                <label for="email" class="block mb-2 text-sm font-medium text-primary-1">Email</label>
                                <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="admin@gmail.com" required onChange={(e)=>setEmail(e.target.value)}/>
                            </div>
                            <div>
