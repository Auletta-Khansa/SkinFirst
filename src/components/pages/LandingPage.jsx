...
const LandingPage = () => {
  return (
    ...
    <div className='min-h-screen px-40 '>
        <div className='flex'>
            <div className='pt-60 relative z-10'>
                ...
                <h2 className='text-[47px] w-3/4 font-medium pb-4'>Nourish your skin, aware your skin health with SkinFirst.</h2>
            ...
            <div className='right-0 top-28 absolute z-0'>
    ...
    <div id="features" className='min-h-screen bg-[#F0EFE1] px-40 z-10 relative'>
      <div className='px-40 pt-40 flex justify-center'>
        <h1 className='text-[50px] font-bold'>Features</h1>
      </div>
      <div className='flex justify-between gap-x-52 pt-20  '>
        <div className='bg-[#013B31] px-10 py-4 text-white rounded-xl shadow-xl w-[75%] pb-20'>
          <h1 className='text-center text-[30px] font-medium pb-8'>Fast Diagnostic</h1>
        ...
        <div className='bg-[#013B31] px-10 py-4 text-white rounded-xl shadow-xl w-[75%] pb-20'>
          <h1 className='text-center text-[30px] font-medium pb-8'>Skin Trivia</h1>
          <p className='text-center'>Various interesting and fun facts related to skin, skin care tips, skin conditions, and more</p>
        </div>
        <div className='bg-[#013B31] px-10 py-4 text-white rounded-xl shadow-xl w-[75%] pb-20'>
          <h1 className='text-center text-[30px] font-medium pb-8'>Overview Result</h1>
